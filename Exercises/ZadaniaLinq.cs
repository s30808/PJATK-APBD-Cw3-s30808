...
public sealed class ZadaniaLinq
{
    ...
    {
        Console.WriteLine("     ska     Imię   Nazwisko   Miasto");
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        if (przedmiot == null)
        {
            return new List<string> { "Nie istnieje taki przedmiot" };
        }

        return new List<string> { $"{przedmiot.Nazwa} (Data startu: {przedmiot.DataStartu:yyyy-MM-dd})" };
    }
    ...
    {
        var czyWszyscy = DaneUczelni.Prowadzacy
    ...
    public IEnumerable<string> Zadanie07_LiczbaAktywnychZapisow()
    {
        ...
        return new List<string> { $"Liczba aktywnych zapisów: {liczba}" };
    }
    ...
    public IEnumerable<string> Zadanie09_TrzyNajnowszeZapisy()
    {
        return DaneUczelni.Zapisy
            ...
            .Take(3)
            .Select(z => $"{z.DataZapisu:yyyy-MM-dd} | ID Studenta: {z.StudentId} | Przedmiot ID: {z.PrzedmiotId}")
            .ToList();
    }
    ...
    public IEnumerable<string> Zadanie11_PolaczStudentowIZapisy()
    {
        return DaneUczelni.Studenci
            .Join(
                ...
                s => s.Id,
                z => z.StudentId,
                (s, z) => $"student: {s.Imie} {s.Nazwisko} - Data zapisu studenta: {z.DataZapisu:yyyy-MM-dd}"
            )
            .ToList();
    }
    ...
    public IEnumerable<string> Zadanie12_ParyStudentPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(
                ...
                temp => temp.z.PrzedmiotId,
                p => p.Id,
                (temp, p) => $"student: {temp.s.Imie} {temp.s.Nazwisko} przedmiot: {p.Nazwa}"
            )
            .ToList();
    }
    ...
    public IEnumerable<string> Zadanie13_GrupowanieZapisowWedlugPrzedmiotu()
    {
        return DaneUczelni.Zapisy
            ...
            .GroupBy(nazwa => nazwa)
            .Select(grupa => $"przedmiot: {grupa.Key} {grupa.Count()} - zapisów")
            .ToList();
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Select(grupa => $"przedmiot: {grupa.Key}. średnia - {grupa.Average(x => x.OcenaKoncowa):F2}")
            .ToList();
    }
    ...
    public IEnumerable<string> Zadanie15_ProwadzacyILiczbaPrzedmiotow()
    {
        return DaneUczelni.Prowadzacy
            .GroupJoin(
                ...
                pr => pr.Id,
                p => p.ProwadzacyId,
                (pr, przedmiotyGrupa)  => $"prowadzący: {pr.Imie} {pr.Nazwisko} - {przedmiotyGrupa.Count()} przedmiotów"
            )
            .ToList();
    }
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Studenci
            ...
            .Select(grupa => $"{grupa.Key.Imie} {grupa.Key.Nazwisko}: Najwyższa ocena {grupa.Max(x => x.OcenaKoncowa)}")
            .ToList();
    }
    ...
    public IEnumerable<string> Wyzwanie01_StudenciZWiecejNizJednymAktywnymPrzedmiotem()
    {
        return DaneUczelni.Studenci
            ...
            .Where(x => x.Liczba > 1)
            .Select(x => $"{x.Imie} {x.Nazwisko} {x.Liczba} - liczba aktywnych przedmiotów")
            .ToList();
    }
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        return DaneUczelni.Przedmioty
            ...
            .GroupJoin(
                ...
                p => p.Id,
                z => z.PrzedmiotId,
                (p, zapisyGrupa) => new { p.Nazwa, zapisyGrupa }
            )
            .Where(temp => temp.zapisyGrupa.All(z => !z.OcenaKoncowa.HasValue))
            .Select(temp => $"{temp.Nazwa}")
            .ToList();
    }
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy
            ...
            .Select(grupa => $"{grupa.Key.Imie} {grupa.Key.Nazwisko}: Średnia ocen {grupa.Average(x => x.OcenaKoncowa):F2}")
            .ToList();
    ...
    public IEnumerable<string> Wyzwanie04_MiastaILiczbaAktywnychZapisow()
    {
        return DaneUczelni.Studenci
            ...
            .Select(x => $"{x.Miasto}: {x.Liczba} aktywnych zapisów")
            .ToList();
